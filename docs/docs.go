        ...
        "/api/v1/questions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filtrar por tipo (single_choice, multiple_choice, code_completion)",
                        "name": "type",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Filtrar por temas (UUIDs separados por coma)",
                        "name": "topicIds",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/questions.UpdateQuestionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/sessions.SessionDetailResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sessions.AnswerRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/sessions.NextQuestionResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "questions.CreateQuestionRequest": {
            ...
            "properties": {
                ...
                "options": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/questions.CreateOptionReq"
                    }
                },
                "source": {
                    "type": "string",
        ...
        "questions.QuestionResponse": {
            ...
            "properties": {
                ...
                "options": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/questions.OptionResponse"
                    }
                },
                "source": {
                    "type": "string"
