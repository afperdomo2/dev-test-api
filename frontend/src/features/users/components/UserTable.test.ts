...
const mockUsers = [
  { id: '1', email: 'a@b.com', isAdmin: true, createdAt: '2026-08-28T12:00:00Z', updatedAt: '2026-08-28' },
  { id: '2', email: 'c@d.com', isAdmin: false, createdAt: '2026-08-27T12:00:00Z', updatedAt: '2026-08-27' },
]
...
describe('UserTable', () => {
  it('renders v-data-table with items', () => {
    ...
    expect(wrapper.findComponent({ name: 'VDataTable' }).exists() || wrapper.html().length > 0).toBeTruthy()
  })
  ...
  it('headers defined', () => {
    ...
    if (headers) {
      expect(headers.map((h) => h.title)).toEqual(expect.arrayContaining(['Email', 'Rol', 'Acciones']))
    } else {
