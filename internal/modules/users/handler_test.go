...
type mockUserService struct {
	createFn  func(email, password string, isAdmin bool) (*models.User, error)
...
func (m *mockUserService) Create(e, p string, a bool) (*models.User, error) {
	return m.createFn(e, p, a)
}
...
func TestUsersHandler_Create(t *testing.T) {
	t.Run("success 201", func(t *testing.T) {
		svc := &mockUserService{
			createFn: func(string, string, bool) (*models.User, error) {
